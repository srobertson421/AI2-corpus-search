...
var _ResultList = __webpack_require__(55);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h1',
              { style: { marginTop: '6.7rem', marginLeft: '3rem' } },
              'Corpus Search'
            )
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'column' },
            _react2.default.createElement(_Search2.default, { handleSearchResults: this.handleSearchResults })
          )
        ),
        _react2.default.createElement(
          'section',
...
var Search = function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function handleSearch(e) {
      ...
      var searchTerms = e.target.search.value.replace(/[\.-\/#!$%\^&\*;:{}=\-_`~()@\+\?><\s\[\]\+]/g, '').toLowerCase().split(',');

      _axios2.default.post('/search', { searchTerms: searchTerms }).then(function (response) {
        _this2.props.handleSearchResults(response.data);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', name: 'search', placeholder: 'Enter search terms - separate multiple with commas' }),
        _react2.default.createElement(
          'button',
          { type: 'submit' },
          'Search'
...
var _ResultList = __webpack_require__(56);

var _ResultList2 = _interopRequireDefault(_ResultList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ResultList2.default;
...
var _ResultListItem = __webpack_require__(57);
...
function renderResults(results) {
  return Object.keys(results).map(function (key) {
    ...
    return _react2.default.createElement(_ResultListItem2.default, { key: key, result: result, docName: key });
  });
}
...
var _ResultListItem = __webpack_require__(58);

var _ResultListItem2 = _interopRequireDefault(_ResultListItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ResultListItem2.default;
...
var ResultListItem = function ResultListItem(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "a",
        { href: "/document/" + result.file, target: "_blank" },
        docName,
        ": ",
        result.file,
        " - TF Score: ",
...
if(false) {
	module.hot.accept("!!../../css-loader/index.js!./milligram.min.css", function() {
		var newContent = require("!!../../css-loader/index.js!./milligram.min.css");
...
module.exports = __webpack_require__.p + "a57c0f8857955e521e1b775e28dbf3b3.png";
